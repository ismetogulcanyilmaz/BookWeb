<%@ Page Title="" Language="C#" MasterPageFile="~/AdminWeb/Admin.Master" AutoEventWireup="true" CodeBehind="AdminBookOrder.aspx.cs" Inherits="KitapWeb.AdminWeb.AdminBookOrder" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      ...
      <div class="form-group row">
          <div class="col-lg-5">
            ...
            <asp:TextBox ID="tbx_AddId" CssClass="form-control" runat="server"></asp:TextBox>
            ...
            <asp:TextBox ID="tbx_AddBookId" CssClass="form-control" runat="server"></asp:TextBox>
          ...
          <div class="col-lg-5">
            ...
            <label for="exampleFormControlInput1">BookId</label>
            <asp:TextBox ID="tbx_UpdateBookId" CssClass="form-control" runat="server"></asp:TextBox>
